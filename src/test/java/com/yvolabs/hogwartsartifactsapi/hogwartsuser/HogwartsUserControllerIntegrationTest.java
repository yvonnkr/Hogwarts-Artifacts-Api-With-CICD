...
class HogwartsUserControllerIntegrationTest {
    ...
    void setUp() throws Exception {
        // User john has all permissions - admin user
    ...
    @Test
    @DisplayName("Check deleteUser with invalid token")
    void testDeleteUserThrowsInvalidBearerTokenExceptionWithInvalidToken() throws Exception {
        String invalidToken = "Bearer eyJhbGciOiJSUzI1NiJ9.eyJpc3MiOiJzZWxmIiwiZXhwIjoxNzE0NTg2NjcyLCJpYXQiOjE3MTQ1Nzk0NzIsImF1dGhvcml0aWVzIjoiUk9MRV9hZG1pbiBST0xFX3VzZXIifQ.X8THGXvm2vfNrwltelTbkfDtASojLo0svZ13OXt_E9njZA01xSx04g7rKl_pF3DGtoCU2kIKSoQ7sXlL5VuMehdquov7RYNXvqclkmjssu-Rmu-h0Sz_Oc_VtwEmqNXkw5uCxsJ-56pH8yhHhYjuedhna36o1OwwpTGY_64DE1HmpayNYW_A83GgSo14qV5hU29y46jN9wq3d3CykLbWVMWTA1Yv7sZGgldruwhnhS3linr0W7Uq8CjgP12K1OQoN91E-KvqZUpT_Qt0XY-HjJtA09EStNcpAIes7Wsv9sbkyjyxS_eMpa1luEWLkzlyvoKeexELc7-PWzWXr6XPlA";

        this.mockMvc.perform(delete(this.baseUrl + "/users/2")
                        .accept(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, invalidToken))
                .andExpect(jsonPath("$.flag").value(false))
    ...
    @Test
    @DisplayName("Check Invalid Endpoint")
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.BEFORE_METHOD)
